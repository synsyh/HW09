"""
SSW810-HW11_Test_Yuning_Sun by Yuning Sun
11:10 下午 11/13/19
...
from HW11_Yuning_Sun import Repository
...
class TestRepository(unittest.TestCase):
    def test_repository(self):
        ...
        # HW11 part
        db = sqlite3.connect('/Users/sunyuning/Documents/SSW810/810_startup.db')
        instructor_summary = []
        for row in db.execute('select * from instructors_summary'):
            instructor_summary.append(list(row))
        self.assertEqual(instructor_summary,
        ...
        with self.assertRaises(sqlite3.OperationalError):
            sqlite3.connect('/Users/sunyuning/Documents/SSW810/810_startu.db').execute(
                'select * from instructors_summary')
